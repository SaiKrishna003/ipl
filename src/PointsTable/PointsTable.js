        ...
        <tbody>
          {
            ...
            teamLogos.map((logo,index) => { 
              return (
                <tr key={logo.Team}>
                  <td>{index+1}</td>
                  <td className='d-flex justify-content-start align-items-center gap-4' id='teamName'>
                    <img src={`data:${logo.logo.contentType};base64,${logo.logo.data}`} alt={logo.Team} height='30px'/>
