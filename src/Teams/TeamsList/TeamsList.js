...
const TeamsList = (props) => {
  ...
  const myClickHandler = (event) => {
    ...
    const myLinks = document.querySelectorAll('#teamsList .navbar-nav .nav-item');
    ...
    <div id='teamsList'>
      <div className='navbar'>
        <ul className='navbar-nav'>
          { 
          teamLogos &&
          teamLogos.map(logo => <li className='nav-item d-flex p-2 align-items-center gap-3' key={logo.Team} id={logo.Team} onClick={myClickHandler}>
