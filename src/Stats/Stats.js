...
const Stats = () => {
  ...
  return (
    <div className='container'>
      <div className='mb-3'>
        <button className='btn btn-outline-primary me-3 fw-bold active' onClick={onClickHandler} id='allStats'>All Time Stats</button>
        <button className='btn btn-outline-primary fw-bold' onClick={onClickHandler} id='currentStats'>Current Stats</button>
      </div>
        {
          toggle ? 
          <div>
